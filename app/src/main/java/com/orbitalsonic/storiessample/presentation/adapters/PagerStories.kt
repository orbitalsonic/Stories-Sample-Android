...
class PagerStories(fragmentManager: FragmentManager, lifecycle: Lifecycle, private val stories: List<ItemStoryCategoryLib>) : FragmentStateAdapter(fragmentManager, lifecycle) {
